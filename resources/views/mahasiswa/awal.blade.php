...
<div class="panel panel-default">
	<div class="panel-heading">
		<strong>Seluruh mahasiswa</strong>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="{{ url('mahasiswa/edit/'.$mahasiswa->id) }}" class="btn btn-info btn-xs" data-toggle="tooltip" data-palcement="top" title="Ubah"><i class="fa fa-pencil"></i></a>
						<a href="{{ url('mahasiswa/'.$mahasiswa->id) }}" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="top" title="lihat"><i class="fa fa-eye"></i></a>
